...
-- 2022-05-30,KDoehlert,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_KDoehlert')
	 Begin 
	  Alter Database [Assignment07DB_KDoehlert] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_KDoehlert;
	 End
	Create Database Assignment07DB_KDoehlert;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_KDoehlert;
